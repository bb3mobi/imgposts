...
$lang = array_merge($lang, array(
	...
	'IMAGES_ATACHMENT_EXPLAIN'		=> 'Если выбрано &laquo;Вложения&raquo;, будут показаны миниатюры вложений, если выбрано &laquo;Изображения&raquo;, будут показаны миниатюры изображений со строрниих ресурсов ([img][\img]).<br />Если выбрано &laquo;Все&raquo;, будут показаны миниатюры обоих типов <span class="error">(не рекомендуется, так как это значительно увеличит нагрузку)</span>',
